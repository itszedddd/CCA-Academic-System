...
export default function App() {
  ...
  const handleFileUpload = async (e) => {
    ...
    { name: 'New Students',       icon: 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z', roles: ['Admission'] },
    ...
    { name: 'Student Archive', icon: 'M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4', roles: ['Registrar', 'Admission'] },
    { name: 'Requests',           icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', roles: ['Registrar'] },
      ...
      <div className="flex-1 flex flex-col overflow-hidden print:overflow-visible print:h-auto">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto print:overflow-visible print:h-auto bg-slate-50 dark:bg-slate-900 p-4 md:p-8 transition-colors duration-300">
          <div className="max-w-7xl mx-auto">
            ...
            { activeTab === 'Student Registration'     && <Registration {...sharedProps} /> }
            { activeTab === 'Enrollment Status'   && <Registration {...sharedProps} /> }
            { activeTab === 'New Students'        && <NewStudents {...sharedProps} /> }
            { activeTab === 'Student Clearance'   && <StudentClearance {...sharedProps} /> }
            { activeTab === 'Reports'            && <Reports {...sharedProps} /> }
            { activeTab === 'Tuition AI Tracker' && <TuitionML {...sharedProps} /> }
            { activeTab === 'Digital Forms'      && <DigitalForms {...sharedProps} /> }
            ...
            { activeTab === 'Requests'           && <Requests {...sharedProps} /> }
